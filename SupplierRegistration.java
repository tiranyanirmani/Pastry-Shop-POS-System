...
public class SupplierRegistration extends javax.swing.JFrame {
    ...
    public void loadSuppliers() {
        ...
        try {
            ...
            ResultSet rs = MYSQLS.search("SELECT * FROM `supplier` ORDER BY `supplier`.`id` ASC");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Supplier Name", "Contact Number", "Address"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (name.isEmpty()) {
            ...
            try {
                ResultSet rs = MYSQLS.search("SELECT * FROM `supplier` WHERE `Address`='" + address + "' OR `Contact_number`='" + cnumber + "'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Supplier aleredy exists", "Warning", JOptionPane.WARNING_MESSAGE);

                } else {

                    MYSQLS.iud("INSERT INTO `supplier` (`Name`, `Contact_number`, `Address`) VALUES ('" + name + "', '" + cnumber + "', '" + address + "');");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            if (r == -1) {
                ...
                grn.jLabel4.setText(id);
                grn.jLabel5.setText(sname);
                grn.jLabel6.setText(contact);
                grn.jLabel7.setText(address);
